...
SQLite FTS ranking is weighted to better match the PostgreSQL-backed search behavior used by other query paths, so subject/body weighting should feel more consistent across local tools.
